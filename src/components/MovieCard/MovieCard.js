...
import { GenresConsumer } from '../GenreContext'
import MovieService from '../../services/MovieService'
import icon from '../../assets/csaff-no-poster.jpg'
...
export default class MCard extends Component {
  ...
  rateMovie = (value) => {
    ...
    this.MovieService.rateMovie(value, this.props.id, guestID).catch(this.onError)
  }
